    ...
    <section class="content-header">					
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="{{ url('admin/recevied/'.$recevied->id) }}/update" method="POST" id="receviedForm" name="receviedForm">
                        @csrf
                        @method('PUT')
						<div class="card">
							<div class="card-body">								
								<div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="invoiceno" id="invoiceno" class="form-control" value="{{ old('invoiceno',$recevied->invoiceno) }}" placeholder="invoiceno">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Amount" id="Amount" class="form-control"  value="{{ old('Amount',$recevied->Amount) }}" placeholder="Amount">	
                                            <p></p>	
										</div>
									</div>
						...
						<div class="pb-5 pt-3">
						 	 ...
						 	 <button type="{{ route('recevied.index') }}" class="btn btn-primary">update</button> 
