...
<head>
  ...
  <title>LARAVEL MASTER | Dashboard</title>
...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ asset('admin assets/dist/img/user1-128x128.jpg')}}" alt="User " class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Laravel Master</span>
    </a>
      ...
      <nav class="mt-2">
        ...
        <!--   <li class="nav-item menu-open"> -->
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href='{{ route("leadmanages.store") }}'   class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Lead Management
          ...
          <li class="nav-item">
            <a href='{{ route("clientmanages.store") }}'  class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Client Management
                <span class="badge badge-info right"></span>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href='{{ route("invoice.store") }}'  class="nav-link">
                  <i class="nav-icon fas fa-copy"></i>
          ...
          <li class="nav-item">
            <a href='{{ route("recevied.store") }}' class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Received
                <span class="badge badge-info right"></span>
