    ...
    <section class="content-header">					
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action= "{{ url('admin/products/'.$products->id) }}/update" method="POST" id="productsForm" name="productsForm">
                        @csrf  
                        @method ('PUT') 
						<div class="card">
							<div class="card-body">								
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
                                            ...
                                            <select name="company" id="company" class="form-control">
                                                <option {{ ($products->company) ? 'company': '' }} vlaue="company">company</option>
                                                <option {{ ($products->chain) ? 'chain': '' }} vlaue="chain">chain</option>
                                                <option {{ ($products->trophy) ? 'trophy': '' }} vlaue="trophy">trophy</option>
                                                </select>
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="productservicename" id="productservicename" class="form-control" placeholder="productservicename" value="{{ old('productservicename', $products->productservicename) }}">	
                                            <p></p>	
										</div>
									</div>                                                                                                           
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="price" id="price" class="form-control" placeholder="price" value="{{ old('price', $products->price) }}">	
                                            <p></p>	
										</div>
									</div>
