    ...
    <section class="content-header">					
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href='{{ route("clientmanages.store") }}' class="btn btn-primary">Back</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="{{ route('leadmanages.store') }}" method="POST" id="leadmanagesForm" name="leadmanagesForm">
                        @csrf  
						<div class="card">
							<div class="card-body">								
								<div class="row">
										...
										<div class="mb-3">
											<label for="Product">Product</label>
                                              ...
                                              <option value="">Select product</option>
                                                ...
                                                <option value="{{  $products->company }}">{{  $products->company}}</option>
                                                @endforeach
                                           </select>
											<!-- <select name="Product" id="Product" class="form-control">
						...
						<div class="pb-5 pt-3">
							<button type="{{ route('leadmanages.store') }}" class="btn btn-primary">Create</button>
