...
@section('content')
    ...
    <section class="content-header">					
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{ route('leadmanages.index') }}" class="btn btn-primary">Back</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="{{ url('admin/leadmanages/'.$leadmanages->id) }}/update" method="POST" id="leadmanagesForm" name="leadmanagesForm">
                        @csrf  
                        @method ('PUT')
						<div class="card">
							<div class="card-body">								
                                ...
                                <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Name" id="Address" class="form-control" placeholder="Name" value= "{{ old('Name',$leadmanages->Name) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Emailid" id="Emailid" class="form-control" placeholder="Emailid" value= "{{ old('Emailid',$leadmanages->Emailid) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="ContactNo" id="Address" class="form-control" placeholder="ContactNo" value="{{ old('ContactNo',$leadmanages->ContactNo) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="ComapanyDetails" id="ComapanyDetails" class="form-control" placeholder="ComapanyDetails"  value="{{ old('ComapanyDetails',$leadmanages->ComapanyDetails) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Address" id="Address" class="form-control" placeholder="Address" value="{{ old('Address',$leadmanages->Address) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="GSTNo" id="GSTNo" class="form-control" placeholder="GSTNo"  value="{{ old('GSTNo',$leadmanages->GSTNo) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<select name="EmployeeName" id="EmployeeName" class="form-control">
                                                <option vlaue=" ">EmployeeName</option>
						...
						<div class="pb-5 pt-3">
							...
							<a href="{{ route('leadmanages.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
						</div>
                        </form>
					</div>
					<!-- /.card -->
    ...
    <script>
        ...
        $("#leadmanagesForm").submit(function(event){
            event.preventDefault();
            var element = $(this);

           
            $.ajax({
                url: '{{ route("leadmanages.store") }}',
                type: 'post',
                ...
                success: function(response){
                    ...
                    if(response["status"] == true){ 
                        ...
                        window.location.href = "{{ route('leadmanages.index') }}";
