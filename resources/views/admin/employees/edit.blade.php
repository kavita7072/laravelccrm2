    ...
    <section class="content-header">					
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="{{ url('admin/employee/'.$employee->id) }}/update"  method="POST" id="employeeForm" name="employeeForm">
                        @csrf 
                        @method('PUT')   
						<div class="card">
							<div class="card-body">								
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<select name= "company" id="company" class="form-control">
                                                <option  {{ ($employee->company) ? 'company': '' }} value=" ">company</option>
                                                <option  {{ ($employee->xyz) ? 'xyz': '' }} value="xyz">xyz</option>
                                                <option  {{ ($employee->company) ? 'xyzzz': '' }} value="xyzzz">xyzzz</option>
                                           </select>	
										</div>
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Name" id="Name" class="form-control" placeholder="Name" value= "{{ old('Name', $employee->Name) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="contactno" id="GSTIN" class="form-control" placeholder="contactno" value= "{{ old('contactno', $employee->contactno) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="guardian" id="guardian" class="form-control" placeholder="guardian"  value= "{{ old('guardian', $employee->guardian) }}">	
                                            <p></p>	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="guardianno" id="guardianno" class="form-control" placeholder="guardianno"  value= "{{ old('guardianno', $employee->guardianno) }}">	
                                            <p></p>	
										</div>
									</div>
						...
						<div class="pb-5 pt-3">
							<button type="{{ route('employee.index') }}" class="btn btn-primary">update</button>
